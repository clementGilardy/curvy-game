                ...
                .with_children(|parent| {
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            ...
                            parent.spawn(TextBundle::from_section("Quitter", button_text_style));
                        });
                });
        });
}
    ...
    commands
        ...
        .with_children(|parent| {
            parent
                ...
                .with_children(|parent| {
                    for (action, text) in [
                        (MenuButtonAction::SettingsDisplay, "Affichage"),
                        (MenuButtonAction::SettingsSound, "Son"),
                        (MenuButtonAction::BackToMainMenu, "Retour"),
                    ] {
                        parent
                            .spawn((
                                ButtonBundle {
            ...
            parent
                ...
                .with_children(|parent| {
                    ...
                    parent
                        ...
                        .with_children(|parent| {
                            parent.spawn(TextBundle::from_section("Retour", button_text_style));
                        });
                });
        });
}
